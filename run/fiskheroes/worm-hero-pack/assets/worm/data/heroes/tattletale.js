...
var SCAN_INTERVAL = 40;       // ticks between auto-scans (2 seconds)
...
function scanTarget(entity, manager) {
            ...
            try {
                ...
                if (helm != null && !helm.isEmpty()) {
                    ...
                    if (heroType != null && heroType != "") {
                        ...
                        var display = raw.replace(/_/g, " ").replace(/\b\w/g, function (c) { return c.toUpperCase(); });
                        p.addChatMessage("\u00A7e\u00A7o  Suit: \u00A7r\u00A7f" + display);
                    }
                }
            } catch (e) {}
        }
    ...
    manager.setData(entity, "worm:dyn/tt_headache", Math.min(1.0, headache + HEADACHE_SCAN_SPIKE));
...
function init(hero) {
    ...
    hero.setTickHandler(function (entity, manager) {
        ...
        if (active) {
            ...
            headache = Math.min(1.0, headache + HEADACHE_BUILD);
